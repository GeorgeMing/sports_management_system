...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-04-19 09:09:17
-- 服务器版本： 5.7.14
-- PHP Version: 7.0.10
...
INSERT INTO `think_course` (`courseId`, `courseName`, `classRangeId`, `adminId`, `time`, `peopleNumber`, `choiceNumber`, `endingTime`) VALUES
(184, '123334', '{"17": "高一（7）班", "18": "高一（8）班", "19": "高一（9）班", "25": "高二（5）班", "26": "高二（6）班", "31": "高三（1）班", "32": "高三（2）班", "33": "高三（3）班", "214": "高二（14）班"}', '刘老师', '', 0, 0, '2017-04-17'),
(447, '123', '{"25": "高二（5）班"}', '周老师', '23', 23, 0, '2017-04-25'),
(448, '234', '{"22": "高二（2）班"}', '吴老师', '123', 123, 0, '2017-04-30'),
(463, '51251', '{"17": "高一（7）班"}', '王老师', '515', 15, 2, '2017-04-25'),
(464, 'test', '{"17": "高一（7）班", "27": "高二（7）班", "32": "高三（2）班"}', '王老师', '周三八九节', 3, 3, '2017-04-03'),
(461, '14551', '{"27": "高二（7）班"}', '王老师', '14', 15, 2, '2017-05-11'),
(462, '14151', '{"27": "高二（7）班"}', '王老师', '515', 16, 2, '2017-05-01'),
(495, '1qwe', '{"11": "高一（1）班"}', '王老师', '33', 414, 0, '2017-04-30');
...
INSERT INTO `think_student_score` (`id`, `no`, `courseId`, `score`, `other_score`, `semester`) VALUES
(67, '1234', 180, '0', '[]', 1),
(70, '123456', 449, '0', '[]', 1),
(144, '123457', 449, '0', '[]', 1),
(153, '140201011022', 464, '36.599999999999994', '{"实验成绩": "34#60", "平时成绩": "34#30", "最后成绩": "54#0", "考试成绩": "60#10"}', 1),
(155, '140201011031', 464, '46.5', '{"实验成绩": "45#60", "平时成绩": "45#30", "最后成绩": "67#0", "考试成绩": "60#10"}', 1),
(156, '123456', 464, '64.8', '{"实验成绩": "65#60", "平时成绩": "66#30", "最后成绩": "78#0", "考试成绩": "60#10"}', 1),
(164, '123457', 462, '23', '0', 21),
(162, '123457', 464, '61', '0', 21),
(163, '123457', 461, '59', '0', 21);
...
('123457', '1234', '小红', 0, 27, 1),
('123', '1234', '小军', 1, 32, 1),
('1234', '1234', '宝宝', 1, 22, 2),
('140201011022', '1234', '小治', 1, 17, 1),
('140201011031', '123', '小明', 1, 17, 1);
...
--
ALTER TABLE `think_course`
  MODIFY `courseId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=496;
--
