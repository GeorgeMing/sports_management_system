...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-03-24 10:48:07
-- 服务器版本： 5.7.14
-- PHP Version: 7.0.10
...
(463, '51251', '{"17": "高一（7）班"}', '王老师', '515', 15, 2),
(464, 'test', '{"17": "高一（7）班", "27": "高二（7）班", "32": "高三（2）班"}', '王老师', '周三八九节', 3, 3),
...
(70, '123456', 449, '0', '[]', 1),
(144, '123457', 449, '0', '[]', 1),
(151, '123457', 464, '0', '{"实验成绩": "90#60", "平时成绩": "30#30", "考试成绩": "60#10"}', 1),
(153, '140201011022', 464, '0', '{"实验成绩": "90#60", "平时成绩": "30#30", "考试成绩": "60#10"}', 1),
(155, '140201011031', 464, '0', '{"实验成绩": "90#60", "平时成绩": "30#30", "考试成绩": "60#10"}', 1),
(156, '123456', 464, '0', '{"实验成绩": "90#60", "平时成绩": "30#30", "考试成绩": "60#10"}', 1);
...
--
ALTER TABLE `think_course`
  MODIFY `courseId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=465;
--
